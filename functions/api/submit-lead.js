 ...
 *   1. Al CRM TeleMedCare (principale) — il CRM gestisce le email a info@ecura.it
 *   2. Al Google Sheet via Apps Script webhook (parallelo, fire-and-forget)
 *
 * La notifica email "Nuovo Lead" viene inviata DAL CRM (via Resend/Brevo/SendGrid)
...
export async function onRequestPost({ request, env, waitUntil }) {
  ...
  // Il CRM TeleMedCare gestisce internamente l'invio della mail "Nuovo Lead"
  // a info@ecura.it via Resend/Brevo/SendGrid. Non duplicare qui.
